...
function shirt (brand, model, price, image, buyLink) { 
  this.brand = brand 
  this.model = model
  this.price = price
  this.image = image
...
var welcome = new shirt ('Welcome', 'Miller Faces', '22.95', 'img/miller.jpg')
...
//Push each shirt into the array
